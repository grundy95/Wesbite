...
```{r cptCov, fig.cap='A multivarite time series witha  change in covariance. Can you spot the changepoint by eye?'}
set.seed(3)
...
* Detecting different types of changes (i.e. variance, trends, distributional).
* Alternative methods to the CUSUM (i.e. Likelihood Ratio Test).
